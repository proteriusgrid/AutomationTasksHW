...
public class Main {
    public static void main( String[] args ) {
        ...
        Reader reader1 = new Reader("Petrov V.V.", 1, "IT", "29.11.2000", "+123451234");
        Reader reader2 = new Reader("Morozov M.M.", 2, "IT", "06.12.1995", "+123451311");
        Reader reader3 = new Reader("Fedorov F.F.", 3, "IT", "07.05.2001","+123451567");

        Reader[] readers = {reader1, reader2, reader3};

        Book book1 = new Book("Foundation ", "Isaac Asimov");
        Book book2 = new Book("Cadia Stands (Warhammer 40,000) ", "Justin D. Hill");
